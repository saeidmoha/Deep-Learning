...
# test it
#### commented out to execute the next part
'''
num_steps = 1001
...
'''
#### End commented out to execute the next part
# I got Test accuracy: 88.8%
'''
Problem 1
...
#### commented out for test of the next section
'''
num_steps = 1001
...
'''
# I got Max pool Test accuracy: 90.1%
...
# resut for 1001 steps was: Lenet 5 Test accuracy: 10.0%
